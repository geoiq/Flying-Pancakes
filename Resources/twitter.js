...
function getUserTweets(screen_name) {
    return getTweets("http://api.twitter.com/1/statuses/user_timeline.json?screen_name="+screen_name)
}
function getLocationTweets(lat,lon,radius) {
    return getTweets("http://search.twitter.com/search.json?rpp=100&geocode="+lat+","+lon+","+radius+"mi")
}
